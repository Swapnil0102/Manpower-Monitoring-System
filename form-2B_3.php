        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components mb-5">
               ...
               <li> <a href="\mpms-nitttr-kolkata\form-2A_1.php"><span class=""></span> Job Assign</a></li>
                <li><a href="\mpms-nitttr-kolkata\form-2A_2.php"><span class=""></span> View Assigned Jobs</a>
                 <li class="active"><a href="\mpms-nitttr-kolkata\form-2B_3.php"><span class=""></span> View Staff performance</a></li>
                  <li><a href="\mpms-nitttr-kolkata\form-2C_1.php"><span class=""></span> Pending Jobs</a>
    ...
    <h4> 
        <ull>
          <a href="controlling_office.php">  Controlling Office  </a> >
              <lii><a href="form-2B_3.php"> View Staff Performance </a></lii>
        </ull>
    </h4>
<?php
      } 
?>
            ...
            <tbody>
                            ...
                            $sql = "SELECT * FROM `job_details` WHERE `job_assigner_name` = '$office_name'";
                            ...
                            <td>".$row["job_id"]."</td>
                            <td>".$row["job_type"]."</td><td>".$row["job_description"]."</td><td>".$row["job_status"]."</td><td>".$row["score"]."</td>";}
