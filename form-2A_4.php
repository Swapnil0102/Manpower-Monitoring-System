...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark pt-3 pb-3">
   <img src="/mpms-nitttr-kolkata/images/nitttr-logo.png" height="55px" width="55px" alt="">
        ...
        <form class="d-flex" form action= "form-2A_4.php" method="POST">
...
?>
     ...
     if($_SESSION['designation']== "Controlling Office"){
                ?>
               <li class="active"><a href="\mpms-nitttr-kolkata\form-2A_4.php"><span class=""></span> View Staff Performance</a></li>
               <?php
      } 
?>
<?php
