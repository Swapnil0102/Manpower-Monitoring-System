    ...
    <img src="/mpms-nitttr-kolkata/images/nitttr-logo.png" height="55px" width="55px" alt="">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <!--<a class="nav-link active" href="staff.php">Staff</a>-->
             ...
             <form class="d-flex" form action= "controlling_office.php" method="POST">
    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components mb-5">
                <li class="active">
                <a href="\mpms-nitttr-kolkata\controlling_office.php"><span class=""></span> Home</a>
                </li>
                <li>
                ...
                <a href="\mpms-nitttr-kolkata\form-2A_2.php"><span class=""></span> View & Check Assigned Jobs</a>
                 <a href="\mpms-nitttr-kolkata\form-2A_4.php"><span class=""></span> <p>View Staff Performance</p></a>
...
<div class="row">
                    ...
                    <div class="col-3">
                        <?php
                                    echo "<b style='font-size: 18px;'>".$department."</b>";
                                ?>
                    </div>    <!-- <div class="col-6">
                Prof. Debi Prasad Mishra
            </div> -->
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">View Staff Performance</h5>
                                <!-- <p class="card-text">you can view the performance of the staff.</p> -->
                                <a href="form-2A_4.php" class="btn btn-primary"> View Performance</a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            <img src="\mpms-nitttr-kolkata\images\job_single.png" class="card-img-top w-75 p-3 "alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            <img src="\mpms-nitttr-kolkata\images\job6.jpg" class="card-img-top w-75 p-3" alt="..." >
                            <div class="card-body">
                                <h5 class="card-title">Completed Jobs</h5>
                                <!-- <p class="card-text">you can view the performance of the staff.</p> -->
                                <a href="form-2C_2.php" class="btn btn-primary mt-3">View Completed Jobs</a>
                            </div>
                        </div>
