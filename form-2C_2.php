...
<form class="d-flex" form action= "form-2C_2.php" method="POST">
...
<?php
     if($_SESSION['designation']== "Controlling Office"){
                ?>
               <li><a href="\mpms-nitttr-kolkata\form-2A_2.php"><span class=""></span> View & Check Asigned Jobs</a></li>
               <?php
      } 
?>
<?php
...
?>
             <li> <a href="\mpms-nitttr-kolkata\form-2C_1.php"><span class=""></span> pending Jobs</a>
               ...
               <li class="active"><a href="\mpms-nitttr-kolkata\form-2C_2.php"><span class=""></span> Completed Jobs</a></li>
    ...
    <h4> 
        <ull>
          <a href="controlling_office.php">  Controlling Office  </a> >
              <lii><a href="form-2C_2.php"> Completed Jobs </a></lii>
        </ull>
    </h4>
<?php
      } 
...
<br>
            ...
            <div class="container my-4">
              ...
              $staff = $_SESSION['name'];
              $job_status = "Complete";
                  $sql = "SELECT * FROM `job_details` WHERE (`job_details`.`job_status` = 'Submitted' || `job_details`.`job_status` = 'Completed') && `job_details`.`staff_name` = '$staff'"; 
                  // WHERE bin = '1'
